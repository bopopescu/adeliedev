...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductView.product_arrival_type'
        db.alter_column(u'adelieproj_productview', 'product_arrival_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adelieproj.ProductArrivalType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProductView.product_arrival_type'
        raise RuntimeError("Cannot reverse this migration. 'ProductView.product_arrival_type' and its values cannot be restored.")
    ...
    models = {
        ...
        u'adelieproj.productview': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['adelieproj.Product']"}),
            'product_arrival_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['adelieproj.ProductArrivalType']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'})
        },
