...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrafficType'
        db.create_table(u'adelieproj_traffictype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'adelieproj', ['TrafficType'])

        # Adding model 'Arrival'
        db.create_table(u'adelieproj_arrival', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('traffic_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adelieproj.TrafficType'], null=True)),
            ('user_agent', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'adelieproj', ['Arrival'])

        # Adding model 'ProductArrivalType'
        db.create_table(u'adelieproj_productarrivaltype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'adelieproj', ['ProductArrivalType'])

        # Adding model 'ProductView'
        db.create_table(u'adelieproj_productview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('product_arrival_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adelieproj.ProductArrivalType'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adelieproj.Product'])),
            ('arrival', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adelieproj.Arrival'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'adelieproj', ['ProductView'])


    def backwards(self, orm):
        # Deleting model 'TrafficType'
        db.delete_table(u'adelieproj_traffictype')

        # Deleting model 'Arrival'
        db.delete_table(u'adelieproj_arrival')

        # Deleting model 'ProductArrivalType'
        db.delete_table(u'adelieproj_productarrivaltype')

        # Deleting model 'ProductView'
        db.delete_table(u'adelieproj_productview')
